...
XMVECTOR CCollisionAlogrithm::EPA_GetMTV(GJK_Simplex& simplex,const DirectX::BoundingOrientedBox& boxA,const DirectX::BoundingOrientedBox& boxB) {
	...
	EPA_Triangle t1 = { simplex[0], simplex[1], simplex[2] };
	EPA_Triangle t2 = { simplex[0], simplex[2], simplex[3] };
	EPA_Triangle t3 = { simplex[0], simplex[3], simplex[1] };
	EPA_Triangle t4 = { simplex[1], simplex[3], simplex[2] };
