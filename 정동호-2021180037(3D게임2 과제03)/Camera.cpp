...
void CCamera::UpdateFrustum() {
	...
	BoundingFrustum::CreateFromMatrix(m_xmFrustum, xmmtxProjection);

	XMMATRIX xmmtxView = XMLoadFloat4x4(&m_xmf4x4View);
	XMMATRIX xmmtxInvereseView = XMMatrixInverse(NULL, xmmtxView);
	m_xmFrustum.Transform(m_xmFrustum, xmmtxInvereseView);
}
