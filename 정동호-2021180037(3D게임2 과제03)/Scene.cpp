...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dCBVDescriptorRanges[0].BaseShaderRegister = 2;
	...
	pd3dRootParameters[1].DescriptorTable.pDescriptorRanges = &(pd3dCBVDescriptorRanges[0]);
	pd3dRootParameters[1].ShaderVisibility = D3D12_SHADER_VISIBILITY_ALL;

	pd3dRootParameters[2].ParameterType = D3D12_ROOT_PARAMETER_TYPE_CBV;
	pd3dRootParameters[2].Descriptor.ShaderRegister = 4;
	...
	pd3dRootParameters[14].Descriptor.ShaderRegister = 14;
