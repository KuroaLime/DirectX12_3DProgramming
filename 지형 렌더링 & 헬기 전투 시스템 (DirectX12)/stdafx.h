...
#define _WITH_TEXTURE_TRANSFORM
//#define _WITH_TEXTURE_DISTORTION_TRANSFORM
//#define _WITH_TEXTURE_DISTORTION_TRANSPARENT_TRANSFORM
...
extern bool g_bMirrorReflectPass;
